...
### Which AI should I use? (2026 picker)
`🟢 Beginner ｜ GPT · Claude · Gemini · DeepSeek · Kimi · 豆包`  ·  原创

> I'm a beginner. In one line each, tell me which AI to use for everyday Q&A/writing, for coding, for image generation, and for video. Include any free, China-friendly options. Output as a table: Scenario → Tool → One-line reason.
...
### Doubao's Seed-2.0 Lineup Ships: Lite/Mini for Volume, Pro for Reasoning
...
### Grok 4.5 Launches: Built With Cursor for Coding, Priced Under 40% of Rivals
`🟡 Intermediate ｜ Grok · Grok 4.5 · xAI`  ·  OSCHINA / 搜狐 / 新浪科技（2026-07-09~18）
...
`🟡 Intermediate ｜ Midjourney · 即梦 · 可灵 · Nano Banana`  ·  原创

> [subject] + [action/expression] + [lighting: e.g. soft window light] + [lens: 85mm f/1.4 shallow DOF] + [style: photorealistic, cinematic] + [quality: highly detailed, 8k] --ar 3:4 --style raw

### Let AI write your image prompt
`🟢 Beginner ｜ GPT · Claude · Gemini · 豆包`  ·  原创
...
### Grok's Aurora Image Model: How to Prompt for That "Actually Photographed" Look on X
...
### Gemini Omni Flash Public Preview: Edit a Video Through Conversation, Up to 3 Sequential Edits at a Time
...
### Gemini App Rolls Out Omni Video Model: Mix Text, Image, Audio and Video Inputs to Generate Video Directly
`🟡 Intermediate ｜ Gemini · Gemini Omni · Google`  ·  Google 官方发布 / IndianAI（2026-07-21 Gemini 生态更新）
...
### Claude Code 2.1.212: New /fork Command, Plus Safety Caps on WebSearch and Subagent Spawning
`🔴 Advanced ｜ Claude Code`  ·  Claude Code Changelog / GitHub Releases（2026-07-18）
...
> Instead of describing what you want, give 1–2 input→output examples. Template: Here is the style I want: [example]. Now apply the same style to: [your content].

### Tip: make the AI ask you first
...
### ChatGPT Atlas Browser Shuts Down August 9: Where to Move Your Bookmarks, Passwords and Open Tabs Now
